...
{"thisWeek":"- point1\\n- point2\\n- point3","nextWeek":"- point1\\n- point2\\n- point3"}`);
    ...
    const doc = new Document({
      ...
      sections: [{
        properties: {
          page: {
            // docx library swaps width/height when orientation=LANDSCAPE
            // so pass portrait dimensions and let the library rotate
